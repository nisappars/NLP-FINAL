-- Industrial Embedded System Module: System_Module_004
-- Generated for Stress Testing
with Ada.Text_IO;
use Ada.Text_IO;

procedure System_Module_004 is
    ...
    procedure Monitor_Health (Input : in Integer) is
