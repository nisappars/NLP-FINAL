-- Industrial Embedded System Module: System_Module_029
-- Generated for Stress Testing
with Ada.Text_IO;
use Ada.Text_IO;

procedure System_Module_029 is
...
begin
    -- Main Control Loop
    loop
        -- [NEW] Added Pre-Check Logic
        if Current_Control.Temperature > 900.0 then exit; end if;
